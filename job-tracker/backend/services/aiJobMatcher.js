...
const { loadPromptFile } = require('./loadPrompt');
...
async function scoreJobMatch(userProfile, jobData) {
...
async function scoreBatchJobMatches(userProfile, jobs) {
  const results = [];
...
module.exports = { scoreJobMatch, scoreBatchJobMatches };
